<?php
    ...
    foreach($resultado as $fila){
        ...
        $sub_array[] = $imagen;
        $sub_array[] = '<button type="button" name="editar" id="'.$fila["id_producto"].'" class="btn btn-warning btn-sm editar"><i class="fa-solid fa-pencil"></i></button>';
        $sub_array[] = '<button type="button" name="borrar" id="'.$fila["id_producto"].'" class="btn btn-danger btn-sm borrar"><i class="fa-solid fa-trash-can"></i></button>';
        $datos[] = $sub_array;
    }
