...
?>                          
                    ...
                    <tr>
                        <td style="font-size:10px; border-right-color: white; border-left-color: white; border-top-color:white;"  colspan="4" > <STRONG>  REPORTE DE ENTRADAS Y SALIDAS DE : Mavel Condori Flores  </STRONG></td> 
                    </tr>
                ...
                <?php 
                    ...
                    $dompdf->stream('Asistencia-Mavel',array('attachment'=>0));
