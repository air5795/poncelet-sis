...
?>
    ...
    <div id="watermark">
            <img src="img/fondo_pdf4.png" height="100%" width="100%" />
        </div>
                    
                    
                    
                        <tr style="text-align: right; background-color: #5c5c5c; color: white; border:solid white;">
                            <td colspan="1" > <STRONG style="font-size:10px;"> <?php echo $DateAndTime;?>  </STRONG></td>
                            
                        </tr>                    
                        <tr>
                            <td colspan="5" style=" border-right-color: white; border-left-color: white; border-top-color:white;"> <STRONG style="font-size:13px;"> PONCELET - COMERCIALIZADORA  </STRONG></td>
                        </tr>
