...
?>                          
                    ...
                    <tr>
                        <td style="font-size:10px; border-right-color: white; border-left-color: white; border-top-color:white;"  colspan="4" > <STRONG>  REPORTE DE ENTRADAS Y SALIDAS DE : Mariana Nicol Erquicia Camacho  </STRONG></td> 
                    </tr>
                ...
                <?php 
                    ...
                    $dompdf->stream('Asistencia-Nicol',array('attachment'=>0));
